...
class CharacterPagesTests: XCTestCase {
    ...
    func testGetPageUrl_NextPage() {
        let infoResponse = Info(count: 10, pages: 2, next: "https://example.com/page=2", prev: "https://example.com/page=1")
    ...
    func testGetPageUrl_MissingPage() {
        let infoResponse = Info(count: 10, pages: 2, next: nil, prev: nil)
